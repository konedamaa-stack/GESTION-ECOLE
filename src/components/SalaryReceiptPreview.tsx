...
interface SalaryReceiptPreviewProps {
  payment: any;
  employee: any;
  schoolInfo: any;
}

export const SalaryReceiptPreview: React.FC<SalaryReceiptPreviewProps> = ({ payment, employee, schoolInfo }) => {
  useEffect(() => {
    ...
    <div className="receipt-container" style={{
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', borderBottom: '2px solid #e5e7eb', paddingBottom: '20px', marginBottom: '30px' }}>
        ...
        <div style={{ textAlign: 'right' }}>
          <h2 style={{ margin: '0 0 8px 0', fontSize: '26px', color: '#10b981', textTransform: 'uppercase', letterSpacing: '1px' }}>FICHE DE PAIE</h2>
      ...
      <div style={{ marginBottom: '40px' }}>
        <div style={{ backgroundColor: '#f8fafc', padding: '20px', borderRadius: '8px', border: '1px solid #e2e8f0', marginBottom: '30px' }}>
          <h3 style={{ margin: '0 0 16px 0', fontSize: '16px', color: '#64748b', textTransform: 'uppercase' }}>Détails de l'Employé</h3>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px' }}>
            ...
            <div>
              ...
              <p style={{ margin: '0', fontWeight: 'bold', fontSize: '16px', color: '#0f172a' }}>{employee.role || 'Employé(e)'}</p>
            </div>
            <div>
      ...
      <div style={{ marginTop: '50px', display: 'flex', justifyContent: 'space-between', color: '#64748b', fontSize: '14px' }}>
        <div>
          <p style={{ margin: '0 0 40px 0' }}>Signature Employeur</p>
          <div style={{ borderBottom: '1px solid #cbd5e1', width: '200px' }}></div>
        </div>
        <div style={{ textAlign: 'right' }}>
          <p style={{ margin: '0 0 40px 0' }}>Signature Employé</p>
